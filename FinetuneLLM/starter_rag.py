...
class RAG_LLM:
    def __init__(self) -> None:
        ...
        self.TRAIN_CORPUS_FPATH = "~/Private_LLM/data/train_corpus.json"
        self.VAL_CORPUS_FPATH = "~/Private_LLM/data/val_corpus.json"
    ...
    def train_RAG(self) -> object:
        ...
        val_dataset = generate_qa_embedding_pairs(
                        llm=Gemini(model_name="gemini-1.5-flash", api_key=self.GOOGLE_API_KEY),
                        nodes=val_nodes,
    ...
    def evaluate_RAG(dataset, embed_model='local:BAAI/bge-small-en', top_k=5,verbose=False):
